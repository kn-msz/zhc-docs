...
<template>
    <section id="hero">
        ...
        <h1 class="tagline">
            <span class="accent">正成</span>
            <br />研发部开放文档
        </h1>
        <p class="description">
            覆盖代码规范、前端架构、实施指南与组件规范四大模块，提供全面而高效的开发支持。
        </p>
        <p class="actions">
            ...
            <a class="setup" href="/guide/quick-start.html">实施指南</a>
    ...
    <section id="highlights" class="vt-box-container">
        <div class="vt-box">
            <h2>代码规范</h2>
            <p>
                严格规范前后端代码风格、命名规则和文件结构，保障项目的高可读性与可维护性。
            </p>
        </div>
        <div class="vt-box">
            <h2>前端架构&主题</h2>
            <p>深入解析前端架构设计与主题开发，涵盖模块化、组件化及性能优化，助力高效开发。</p>
        </div>
        <div class="vt-box">
            <h2>实施指南</h2>
            <p>
                提供清晰的项目实施流程，包括需求分析、开发步骤、测试部署及常见问题解决方案。
            </p>
        </div>
        <div class="vt-box">
            <h2>组件规范</h2>
            <p>
                统一组件开发标准，从目录结构到数据流管理，全面提升组件复用性与一致性。
            </p>
        </div>
    </section>
    <SiteMap></SiteMap>
...
.dark .tagline {
    ...
    background: -webkit-linear-gradient(315deg, #ffffff 25%, #000000);
...
.actions .security {
    ...
    linear-gradient(45deg, #528ce6, #cacaca) border-box;
